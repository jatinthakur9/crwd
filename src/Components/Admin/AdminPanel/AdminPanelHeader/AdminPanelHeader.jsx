...
import AdminPanelCrwdListBox from "./AdminPanelCrwdlistBox/AdminPanelCrwdListBox";
import CrwdStatsPieChart from "../Charts/CrwdStatsPieChart/CrwdStatsPieChart";

const AdminPanelHeader = () => {
  const { email, createEventTrigger } = useContext(userContext);
  const [userN, setUserN] = useState(0);

  const [crwdsT, setCrwdsT] = useState(0);

  const [mainBox, setMainBox] = useState(true);
  const [userBox, setUserBox] = useState(false);
  const [crwdBox, setCrwdBox] = useState(false);
  const [pieCharBox, setPieChartBox] = useState(false);
  //code for popup add
  ...
  //code closes for pop up add

  //code starts for pop up edit
  ...
  useEffect(() => {
    ...
    setCrwdsT(allEvents.length);
  }, [createEventTrigger, mainBox]);
    ...
    <>
      <div className="wrapper">
        ...
        <nav className="main-header navbar navbar-expand navbar-white navbar-light">
          ...
          {/* Right navbar links */}
          <ul className="navbar-nav    " style={{ marginLeft: "1050px" }}>
            {/* Navbar Search */}
            <li className="nav-item">
              <a
                className="nav-link"
        ...
        <div className="content-wrapper">
          ...
          {/* this is where the section starts */}
          {mainBox ? (
          ...
          userBox ? (
            // <p>here will be the userlist</p>
            <div className="userListBox">
              <div className="TopBox">
                <h5>Users</h5>

                <button
                  className="TopBoxButtonn"
                ...
                {showPopup && (
                  <div
                    className="crwd-poppup-overlay"
                    onClick={() => setShowPopup(false)}
                  >
                    <div
                      className="crwd-poppup-box"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <div className="crwd-poppup-header">
                        <h2>Add User</h2>
                        <span
                          className="crwd-close-btn"
                          onClick={() => setShowPopup(false)}
                        >
                          ×
                        </span>
                      </div>
                      {error && <p className="crwd-error">{error}</p>}
                      <input
                        type="text"
                        name="userName"
                      ...
                      <input
                        ...
                        className="crwd-input"
                      />
                      <div className="crwd-poppup-actions">
                        <button onClick={handleSaveee}>Save</button>
                        <button
                          onClick={() => setShowPopup(false)}
                          className="crwd-cancel-btn"
                        >
                          Cancel
                        </button>
                      </div>
            ...
            <AdminPanelCrwdListBox />
          ) : pieCharBox ? (
            <CrwdStatsPieChart />
          ) : (
            // from here the crwd list will start
            // here the crwd list code ends
            <p>here will be the main contenttt </p>
          )}
          {/* this is  where section ends */}
          {/* /.content */}
        </div>
        {/* /.content-wrapper */}
